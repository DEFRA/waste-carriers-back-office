  ...
  RSpec.describe RegistrationEprPresenter do
    ...
    describe "#company_address_address_line1" do
      it "returns the object address address_line1" do
        ...
        expect(registration).to receive(:company_address).and_return(company_address)
        expect(company_address).to receive(:address_line1).and_return(result)
    ...
    describe "#company_address_address_line2" do
      it "returns the object address address_line2" do
        ...
        expect(registration).to receive(:company_address).and_return(company_address)
        expect(company_address).to receive(:address_line2).and_return(result)
    ...
    describe "#company_address_address_line3" do
      it "returns the object address address_line3" do
        ...
        expect(registration).to receive(:company_address).and_return(company_address)
        expect(company_address).to receive(:address_line3).and_return(result)
    ...
    describe "#company_address_address_line4" do
      it "returns the object address address_line4" do
        ...
        expect(registration).to receive(:company_address).and_return(company_address)
        expect(company_address).to receive(:address_line4).and_return(result)
