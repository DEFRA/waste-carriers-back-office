...
class ResendConfirmationEmailController < ApplicationController
  ...
  def handle_missing_contact_email
    message = I18n.t("resend_confirmation_email.messages.missing.heading")
    description = I18n.t("resend_confirmation_email.messages.missing.details")
  ...
  def handle_assisted_digital_contact_email
    message = I18n.t("resend_confirmation_email.messages.assisted.heading")
    description = I18n.t(
      "resend_confirmation_email.messages.assisted.details",
